...
<body>
	...
	<form name="editForm" method="post" action="edit.do" onSubmit="return editSave()">
		<table align=center align=center border=1 bordercolor=#9ED0F8 cellpadding=5 width=700>
			<tr height=40px>
				<td>writer</td>
				<td><input type=hidden name=num id=num value="${boardDto.num}"
					size=10 /> <input type=text name=writer id=writer
					value="${boardDto.writer}" size=10 /></td>
			</tr>

			<tr height="40px">
				<td>subject</td>
				<td><input type="text" name="subject" id="subject"
					value="${boardDto.subject}" size=30 /></td>
			</tr>

			<tr height="40px">
				<td>email</td>
				<td><input type="text" name="email" id="email"
					value="${boardDto.email}" size=30 /></td>
			</tr>
			...
			<tr>
				<td colspan=2 align=center><input type="submit" value="modify">
					<input type="reset" value="reset"> <input type="button" value="go back to list" onClick="document.location.href='list.do'">
				</td>
			</tr>
		</table>
	</form>
